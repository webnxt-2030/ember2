...
export const USDT_ADDRESS = "0xc7d67a9cbb121b3b0b9c053dd9f469523243379a" as const;
export const USDT_DECIMALS = 6;

export const MORPH_RPC_URL = "https://rpc.morphl2.io";
export const MORPH_EXPLORER_URL = "https://explorer.morphl2.io";
