...
interface OrgMemberWithUser { user: { email: string; name: string | null } }
...
export async function PATCH(
  ...
  if (!session) return errorResponse(new AuthError('Unauthorized'), req)
  ...
  if (!updated) return errorResponse(new NotFoundError('Project'), req)
