  ...
  return (
    <>
      ...
      <div className="text-center">
        <Link
          href="/auth/staff"
          className="text-sm font-medium underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 rounded-sm"
          style={{ color: "var(--color-on-surface-variant)" }}
          aria-label="Staff login — for Ember administrators only"
        >
          Staff login
        </Link>
      </div>
